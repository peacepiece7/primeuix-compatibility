import type { PaginatorTokenSections } from '@peacepieceuix-compatibility/themes/types/paginator';

export * from '@peacepieceuix-compatibility/themes/types/paginator';
