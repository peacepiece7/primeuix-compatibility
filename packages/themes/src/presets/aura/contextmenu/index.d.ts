import type { ContextMenuTokenSections } from '@peacepieceuix-compatibility/themes/types/contextmenu';

export * from '@peacepieceuix-compatibility/themes/types/contextmenu';
