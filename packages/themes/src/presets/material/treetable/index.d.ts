import type { TreeTableTokenSections } from '@peacepieceuix-compatibility/themes/types/treetable';

export * from '@peacepieceuix-compatibility/themes/types/treetable';
...
declare const css: TreeTableTokenSections.CSS;
