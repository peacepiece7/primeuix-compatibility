import type { DataTableTokenSections } from '@peacepieceuix-compatibility/themes/types/datatable';

export * from '@peacepieceuix-compatibility/themes/types/datatable';
...
declare const css: DataTableTokenSections.CSS;
