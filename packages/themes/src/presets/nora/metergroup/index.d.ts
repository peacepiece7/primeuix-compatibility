...
declare const colorScheme: MeterGroupTokenSections.ColorScheme;
declare const _default: {
    ...
    colorScheme: MeterGroupTokenSections.ColorScheme;
};

export { colorScheme, _default as default, label, labelIcon, labelList, labelMarker, meters, root };
