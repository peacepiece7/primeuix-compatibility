import type { FileUploadTokenSections } from '@peacepieceuix-compatibility/themes/types/fileupload';

export * from '@peacepieceuix-compatibility/themes/types/fileupload';
...
export { basic, content, _default as default, file, fileList, header, progressbar, root };
